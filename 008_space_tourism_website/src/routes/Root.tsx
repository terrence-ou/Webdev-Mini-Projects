...
const Root = () => {
  ...
  return (
    <div
      className="box-border flex flex-col justify-between mobile:justify-start items-center w-dvw h-dvh mobile:h-full pt-[40px] tablet:pt-0 mobile:pt-0 bg-dark bg-no-repeat bg-cover desktop:min-h-[900px] mobile:min-w-[350px] tablet:overflow-hidden"
      style={style}
    >
