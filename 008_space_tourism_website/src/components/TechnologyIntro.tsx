...
const TechnologyIntro = () => {
  ...
  return (
    <section className="desktop:text-start text-center">
      ...
      <p className="text-violet text-desc tablet:text-desc-tablet mobile:text-desc-mobile font-barlow leading-content tablet:leading-content-tablet mobile:leading-content-mobile max-w-[445px] mobile:w-[327px] mt-[17px]">
