...
export default function Cart() {
    ...
    return (
      <>
            ...
            return (
              <li key={key} className="flex justify-between content-center">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    onClick={() => handleSubtractItem(key)}
                    className="w-4 bg-white"
                  >
                    -
                  </button>
        ...
        <p className="text-right">
          Cart Total: <span className="font-bold pl-4">${totalPrice}</span>
        </p>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <form
        method="dialog"
        className="flex gap-6 justify-center pt-4 mx-auto text-center"
      >
        {!listEmpty && (
          <button className="py-1 rounded-md hover:font-bold">Check Out</button>
        )}
