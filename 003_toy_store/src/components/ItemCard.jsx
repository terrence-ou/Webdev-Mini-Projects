import sampleImg from "../assets/shp001.jpeg"
  ...
  return (
    <div className="relative flex flex-col w-[22%] h-64 rounded-xl bg-gradient-to-t from-[#F2DDC8] via-white via-50% to-white drop-shadow-lg overflow-hidden">
      ...
      <div className="flex justify-between content-end align-bottom px-2 my-auto">
        ...
        <button className="self-end bg-zinc-50 hover:bg-zinc-800 text-zinc-800 hover:text-zinc-50 duration-100 text-[0.6rem] tracking-tight py-1 px-2 rounded-full">Add to Cart</button>
      </div>
    </div>
  )
}
